...
$(document).ready(function() {
    ...
    switch (Core.Environment.context()) {
        ...
        /* USER LIST */
        case 'account/user':
            Account.User.DataTable.init();
            Account.User.Modal.init();
            Account.User.Modal.initExportUsers();
            Account.User.Edit.init();
            Account.User.SecondaryPanel.initUserSearch();
            Account.User.Popover.init();
            break;
        /* USER TYPES */
        case 'account/type':
            Account.UserType.DataTable.init();
            Account.UserType.Modal.init();
            Account.UserType.SecondaryPanel.initUserTypeSearch();
            Account.UserType.Popover.init();
            break;
        default:
            break
...
jQuery.extend(Account, {
    ...
    User: {
                        ...
                        if (updatedItems != undefined && updatedItems.length != 0 && userId != undefined && userId != 0) {
                            ...
                            $.ajax({
                                ...
                                success: function(responseData) {
                                    Core.log('Account.User.Modal Update Vehicle/Landmark Group - on Core.DragDrop.Dropped', 'group');
                                    ...
                                    Core.log('Account.User.Modal Update Vehicle/Landmark Group - on Core.DragDrop.Dropped', 'groupEnd');
                                }
                            });
        ...
        DataTable: {
            ...
            init: function() {
                ...
                Account.User.DataTable.userList = Core.DataTable.init('user-list-table', 20, {
                    'oLanguage': {
                        'sInfo': 'Showing _START_ to _END_ of _TOTAL_ Users'
                    },
                    'bServerSide': true,
                    'sAjaxSource':   '/ajax/account/getFilteredUsers',
                    'aoColumns': [
                        { 'mDataProp': 'name' },
                        { 'mDataProp': 'username' },
                        { 'mDataProp': 'usertype' },
        ...
        Modal: {
                                    ...
                                    if (! $.isEmptyObject(userData)) {
                                        ...
                                        },
                                        {
                                            hidden: function() {
                                                ...
                                                Account.User.DataTable.userList.fnStandingRedraw();
            ...
            initExportUsers: function () {
                ...
                $body.on('click', '#popover-user-list-export-confirm', function() {
                    ...
                    if (search_string != '') {
                        window.location = '/ajax/account/exportFilteredUsersList/string_search/' + search_string + '/All';
                    } else {
                        window.location = '/ajax/account/exportFilteredUsersList/group_filter/' + user_role;
                    }
                });   
            }
        },
            ...
            initUserSearch: function() {
                ...
                $userSearch.on('keyup', function () {
                    ...
                    if (searchUserString.length > 1) {
                        Account.User.DataTable.userList.fnDraw();
    ...
    UserType: {
        ...
        DataTable: {
            ...
            init: function() {
                Account.UserType.DataTable.typeList = Core.DataTable.init('user-type-list-table', 20, {
                    'oLanguage': {
                        'sInfo': 'Showing _START_ to _END_ of _TOTAL_ User Types'
                    },
                    'bServerSide': true,
                    'sAjaxSource':   '/ajax/account/getFilteredUserTypeList',
                    'aoColumns': [
                        { 'mDataProp': 'usertype' },
            ...
            init: function() {
                        ...
                        $.ajax({
                            ...
                            success: function(responseData) {
                                if (responseData.code === 0) {
                                    ...
                                    // redraw table
                                    Account.UserType.DataTable.typeList.fnStandingRedraw();    
                                } else {
                                    if (! $.isEmptyObject(responseData.validation_error)) {
                                        // display validation errors    
                                    }
                ...
                $(document).on('click', '#popover-user-type-delete-confirm', function() {
                    ...
                    if (userTypeId != undefined && userTypeId != '') {
                        $.ajax({
                            url: '/ajax/account/deleteUserType',
                            type: 'POST',
                            dataType: 'json',
                            data: {
            ...
            initUserTypeSearch: function() {
                ...
                $userUserTypeSearch.on('keyup', function () {
                    ...
                    if (searchUserTypeString.length > 1) {
                        Account.UserType.DataTable.typeList.fnDraw();
            ...
            init: function() {
                ...
                $(document).on('click', '.col-type a', function() {
                    ...
                    if (userTypeId != undefined) {
                        ...
                        $.ajax({
                            url: '/ajax/account/getUserTypeById',
                            type: 'POST',
                            dataType: 'json',
                            data: {
                                usertype_id: userTypeId
                ...
                $(document).on('click', '#user-type-permission-save', function() {
                    ...
                    if (validation.length == 0) {
                        $.ajax({
                            url: '/ajax/account/addUserTypePermission',
                            type: 'POST',
                            dataType: 'json',
                            data: data,
                            success: function(responseData) {
