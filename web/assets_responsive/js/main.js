...
//console.log('webApp handleNav submenuLinks');
...
//console.log('webApp handleSidebars');

        // *** Side-Panel Scroll Bar *** DTB ***
        switch(Core.Environment.context()){
            case           'landmark/map' : 
            case            'report/list' : 
            case            'vehicle/map' : var offset = $('.sub-panel-resize').offset().top+8;
                                            var newheight=$(window).height()-offset;
                                            if(newheight<100){
                                                $('.sub-panel-resize').height($(window).height());
                                                console.log('Side Panel: Resized to Window');
                                            } else if ($('.sub-panel-resize').height()!=newheight) {
                                                $('.sub-panel-resize').height(newheight);
                                                console.log('Side Panel: Resized ('+$('.sub-panel-resize').height()+'='+$(window).height()+'-'+offset+')');
                                            }
                                            break;
        }
...
//console.log('webApp templateOptions');
...
//console.log('webApp dtIntegration');
...
//console.log('webApp init function()');
...
//console.log('webApp init sidebars()');

            handleSidebars(mode); // Handle Sidebars Functionality
        },
        datatables: function() {

//console.log('webApp init datatables()');
